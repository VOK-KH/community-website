...
export function CommunityHero() {
  ...
  useLayoutEffect(() => {
    ...
    const o1 = el.querySelector<HTMLElement>('#communityHeroO1')
    const o2 = el.querySelector<HTMLElement>('#communityHeroO2')
    const o3 = el.querySelector<HTMLElement>('#communityHeroO3')
  ...
  return (
    <header ref={heroRef} className="pg-hero" aria-labelledby="community-hero-heading">
      <div className="pg-hero-bg" aria-hidden>
        <div className="pg-hero-noise" />
        <div className="pg-hero-grid" />
        <div className="pg-hero-orb pg-hero-orb--a" id="communityHeroO1" />
        <div className="pg-hero-orb pg-hero-orb--b" id="communityHeroO2" />
        <div className="pg-hero-orb pg-hero-orb--c" id="communityHeroO3" />
      </div>

      <ParticlesBackground id="community-hero-particles" />
      ...
      <div className="pg-hero-inner">
        ...
        <h1 id="community-hero-heading">
          <span className="h1-clip">
            <span className="h1-word">Meet</span>
          </span>{' '}
          <span className="h1-clip">
            <span className="h1-word">Our</span>
          </span>{' '}
          <span className="h1-clip">
            <span className="h1-word gradient-text">Community</span>
          </span>
        </h1>
        ...
        <p className="hero-sub max-w-3xl">
          ...
          <span className="hero-sub-line mt-2 block text-muted-foreground">
            Discussions, spotlights, and events keep you connected to what is happening across the
            ecosystem.
          </span>
        </p>
      </div>
